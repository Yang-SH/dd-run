...
- **M7 进行中**（发布工程，2026-09-08 立项）：GitHub Actions CI（windows-gnu 上 build / test / clippy `-D warnings` / fmt 四关）、`assets/app.ico` 增 256px 档；待做：Inno Setup 安装器、文件搜索扩展分发定案（sidecar vs 内嵌）、tag → Release 发版流程。
