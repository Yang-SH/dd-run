...
> **状态**：生效中 ｜ **版本**：v1.8 ｜ **最后更新**：2026-09-15
...
| [`implementation.md`](./implementation.md) | 生效中 | v0.1.1 | 654 | 维护者 | 实施主线：里程碑状态总表、目标与范围、ADR-1~4、验收映射、遗留台账、实施沿革 |
...
| 文档 | 状态 | 行数 | 职责 |
|---|---|---|---|
| [`search-file.md`](./search-file.md) | 生效中（v3.3） | 923 | **文件搜索的权威技术口径**：双通道传输层、依赖、落地范围、首轮真机验收结论、版本演进 |
...
| [`search-file-p2-acceptance-2026-09-15.md`](./search-file-p2-acceptance-2026-09-15.md) | 生效中 | 169 | **文件搜索 P2 真机验收报告**：A-33-05/06/07/08/10 逐项实测（环境矩阵、耗时分解、1000 次基准、故障注入与恢复链路），含未闭环项与复现命令 |
...
| 文件搜索 P2 真机验收 A-33-05…A-33-10 | [`search-file-p2-acceptance-2026-09-15.md`](./search-file-p2-acceptance-2026-09-15.md) | 🟨 首轮完成（2026-09-15）：A-33-07/10 ✅、A-33-06/08 ⚠️ 部分、A-33-05 ❌ 性能未达标；6 项未闭环见报告 §5。**A-33-06/08 未全通过前，用户文档仍不得承诺「无需 es.exe」** |
