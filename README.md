...
- **M7 in progress** (release engineering, started 2026-09-08): GitHub Actions CI (build / test / clippy `-D warnings` / fmt on windows-gnu), 256px icon tier added to `assets/app.ico`; next: Inno Setup installer, distribution decision for the file-search extension (sidecar vs embedded), tag → release flow.
